...
def build_data_loader(
    ...
    # Build data loader
    # print(dataset_wrapper(data_source, input_size=input_size, transform=tfm, is_train=is_train)[0][0].shape)
    a = dataset_wrapper(data_source, input_size=input_size, transform=tfm, is_train=is_train)
    print(len(a))
